...
void PeriphCommonClock_Config(void)
{
  ...
  */
  PeriphClkInitStruct.PeriphClockSelection = RCC_PERIPHCLK_SPI3|RCC_PERIPHCLK_LTDC;
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, CTP_SCLK_Pin|CTP_SDA_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(LED_PC1_GPIO_Port, LED_PC1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : CTP_NRST_Pin CTP_SCLK_Pin CTP_SDA_Pin */
  GPIO_InitStruct.Pin = CTP_NRST_Pin|CTP_SCLK_Pin|CTP_SDA_Pin;
  ...
  /*Configure GPIO pin : LED_PC1_Pin */
  GPIO_InitStruct.Pin = LED_PC1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(LED_PC1_GPIO_Port, &GPIO_InitStruct);
...
void MPU_Config(void)
{
  ...
  */
  ...
  MPU_InitStruct.BaseAddress = 0x240CB800;
